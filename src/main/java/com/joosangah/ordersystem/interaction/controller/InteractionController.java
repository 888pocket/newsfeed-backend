...
public class InteractionController {
    ...
    public void toggleFollow(@AuthenticationPrincipal User user,
        ...
        interactionService.toggle(user, request.getTargetId(), InteractionType.FOLLOW);
    }
    ...
    public void toggleLikePost(@AuthenticationPrincipal User user,
            @RequestBody InteractionRequest request) {
        interactionService.toggle(user, request.getTargetId(), InteractionType.LIKE_POST);
    }
    ...
    public void toggleLikeComment(@AuthenticationPrincipal User user,
            @RequestBody InteractionRequest request) {
        interactionService.toggle(user, request.getTargetId(),
                InteractionType.LIKE_COMMENT);
    }

    @GetMapping("/newsfeed")
    @PreAuthorize("hasRole('ROLE_USER')")
    public List<InteractionResponse> loadNewsfeeds(@AuthenticationPrincipal User user) {
        return interactionService.loadNewsfeeds(user);
    }
}
